...
class ManageSystem extends Component {
  ...
  render() {
    ...
    return (
      <>
        {islogin &&
        generalHandling.handleCheckPermission(PERMISSIONS.ADMIN, permission) ? (
          <>
                ...
                <div className="l-12">
                  <div className="nav-header">
                    <div className="list-icon-controll">
                      <Tippy
                        content={<SwitchLanguage id="manageAdmin.home" />}
                        height="var(--height-tippy-nav"
                      >
                        <span className="icon-system ">
                          <Link className="nav-icon-home" to={path.HOMEPAGE}>
                            {" "}
                            <HomeIcons />
                          </Link>
                        </span>
                      ...
                      <Tippy
                        content={<SwitchLanguage id="manageAdmin.manageShop" />}
                        height="var(--height-tippy-nav"
                      >
                        <span
                          className={
                          ...
                          onClick={() => this.handleShowPage("showManageShop")}
                        >
                      ...
                      >
                        <span
                          ...
                          onClick={() => this.handleShowPage("showManageUser")}
                        >
                          {showManageUser ? (
                            <ListUserIconsActive />
                          ) : (
                      ...
                      <Tippy
                        content={<SwitchLanguage id="manageAdmin.other" />}
                        height="var(--height-tippy-nav"
                      >
                        <span
                          className={
                          ...
                          onClick={() =>
                            this.handleShowPage("showOtherSystemData")
                          }
                        >
                          <span className="border-icon-nav">
                    ...
                    <div className="List-icon-right">
                      ...
                      <Tippy
                        content={<SwitchLanguage id="manageAdmin.logout" />}
                        height="20"
                      >
                        <span
                          className="log-out"
            ...
            <div className="grid">
              <div className="grid wide">
                <div className="l-12">
                  {showOtherSystemData && loadDataAllCode && (
                    <InputStyle>
                      {" "}
                      <OtherSystemData />{" "}
                    </InputStyle>
