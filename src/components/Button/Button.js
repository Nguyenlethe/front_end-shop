        ...
        return (
            <>
                ...
                type === 'close-form-data' ? <button className='btn-form-input' style={{opacity: opacity,width: width,borderRadius: border, margin: margin}}> <span style={{backgroundColor: color, borderRadius: border, height: height,fontSize: size}} className='content-btn-form-input close'>{content}</span> </button>
                    : 
                type === 'ban-form-data' ? <button className='btn-form-input' style={{opacity: opacity,width: width,borderRadius: border, margin: margin}}> <span style={{backgroundColor: color, borderRadius: border, height: height,fontSize: size}} className='content-btn-form-input ban'>{content}</span> </button>
                    : 
