...
class OtherSystemData extends Component {
  ...
  componentDidMount = async () => {
    ...
    let { dataTabelColor, dataTrademarks, dataCategories, dataType } =
      this.state;
  ...
  handleChangeInput = (value, name) => {
    let { dataTabelColor, dataTrademarks, errData, dataCategories, dataType } =
      this.state;
  ...
  handleSubmit = async (name) => {
    let { dataTabelColor, errData, dataTrademarks, dataCategories, dataType } =
      this.state;

    // COLOR
    if (name === "COLOR") {
      let res = await adminService.createDataOther({
        dataTabelColor,
        type: "COLOR",
      });
  ...
  heandleDataForm = () => {
    ...
    if (optionsCategory !== null) {
      newOptionsCategory = newListCategory.filter(
        (item) => item.value === optionsCategory.value
      );
    }

    newOptionsCategory =
      newOptionsCategory !== null ? newOptionsCategory[0] : null;
      ...
      <>
        ...
        <div className="col l-12">
          <p className="heading-manage-user">
            <SwitchLanguage id="manageAdmin.otherDataSystem" />
          </p>
        </div>

        {/* Color */}
        <p className="heading-other-data col l-12">
          <SwitchLanguage id="manageAdmin.button.addColor" />{" "}
        ...
        <div id="list-input">
          ...
          <Input
            ...
            change={this.handleChangeInput}
          />
          <p className="col l-12 err_message">
            {errData.messageErrColor &&
            errData.messageErrColor.valueEn &&
            languages.EN === language
              ? errData.messageErrColor.valueEn
              : errData.messageErrColor.valueVi}
          </p>
        </div>
        ...
        {/* trademarks */}
        <p className="heading-other-data col l-12">
          <SwitchLanguage id="manageAdmin.items.addTrademarks" />{" "}
        ...
        <div id="list-input">
          ...
          <p className="col l-12 err_message">
            {errData.messageErrTrademarks &&
            errData.messageErrTrademarks.valueEn &&
            languages.EN === language
              ? errData.messageErrTrademarks.valueEn
              : errData.messageErrTrademarks.valueVi}
          </p>
        </div>
        ...
        <span
          className="col l-3"
          onClick={() =>
            dataTrademarks.code.trim() !== "" &&
            dataTrademarks.valueEn.trim() !== "" &&
            this.handleSubmit("TRADEMARKS")
          }
        >
          <Button
            type="submit-form-data"
        ...
        {/* Category */}
        <p className="heading-other-data col l-12">
          <SwitchLanguage id="manageAdmin.items.addCategory" />{" "}
        ...
        <div id="list-input">
          ...
          <p className="col l-12 err_message">
            {errData.messageErrCategories &&
            errData.messageErrCategories.valueEn &&
            languages.EN === language
              ? errData.messageErrCategories.valueEn
              : errData.messageErrCategories.valueVi}
          </p>
        </div>
        ...
        <span
          className="col l-3"
          onClick={() =>
            dataCategories.code.trim() !== "" &&
            dataCategories.valueEn.trim() &&
            dataCategories.valueVi.trim() !== "" &&
            this.handleSubmit("CATEGRORY")
          }
        >
          <Button
            type="submit-form-data"
        ...
        {/* Category type */}
        <p className="heading-other-data col l-12">
          <SwitchLanguage id="manageAdmin.items.addType" />{" "}
          <FontAwesomeIcon icon={faChartSimple} />
        </p>
        <div id="list-input">
          ...
          <p className="col l-12 err_message">
            {errData.messageErrType &&
            errData.messageErrType.valueEn &&
            languages.EN === language
              ? errData.messageErrType.valueEn
              : errData.messageErrType.valueVi}
          </p>
        </div>
        ...
        <span
          ...
          onClick={() =>
            dataType.code.trim() !== "" &&
            dataType.valueEn.trim() &&
            dataType.valueVi.trim() !== "" &&
