...
class CreateUser extends Component {
    ...
    componentDidUpdate= async(prevProps, prevState)=> {
        ...
        if(prevProps.dataDistrict !== this.props.dataDistrict){
            ...
            let district = generalHandling.handlConvertObject(dataDistrict,'DATA_FORM',this.props.language)
            this.setState({
        ...
        if(prevProps.dataWards !== this.props.dataWards){
            ...
            let wards = generalHandling.handlConvertObject(dataWards,'DATA_FORM',this.props.language)
            this.setState({
                listDataWards: wards || []
            })
        }
    ...
    heandleDataForm = (action)  => {
        ...
        let listGender = generalHandling.handlConvertObject(dataForm.listGender,'DATA_FORM',this.props.language)
    ...
    handleShowHideInputsUser = () => {
        ...
        let stateErrorCopy = generalHandling.resetDefaultState(this.state.dataError)
    ...
    handleSetValueForm  = (data) => {
        ...
        let districtData = {value: data.district, label: languages.EN === language ? data.districtData.valueEn : data.districtData.valueVi }
        let genderData = {value: data.gender, label: languages.EN === language ? data.genderData.valueEn : data.genderData.valueVi } 
        let permissionData = {value: data.permission, label: languages.EN === language ? data.permissionData.valueEn : data.permissionData.valueVi } 
        let provinceData = {value: data.province, label: languages.EN === language ? data.provinceData.valueEn : data.provinceData.valueVi } 
        let wardsData = {value: data.wards, label: languages.EN === language ? data.wardsData.valueEn : data.wardsData.valueVi} 
