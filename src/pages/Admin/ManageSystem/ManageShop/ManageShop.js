...
class ManageShop extends Component {
        ...
        return {
          ...
          label:
            language === languages.EN
              ? `${object.FullName.lastName} ${object.FullName.firstName}`
              : `${object.FullName.firstName} ${object.FullName.lastName}`,
        };
      }
    }
  };
  ...
  heandleDataForm = (action) => {
    ...
    let listPay = generalHandling.handlConvertObject(
      dataForm.listPay,
      "DATA_FORM",
      this.props.language
    );
    ...
    let dataListAllUser = generalHandling.handlConvertObject(
      [...allUser],
      this.props.language
    );
    let dataListUser = generalHandling.handlConvertObject(
      [...allUserNotInR2],
      this.props.language
    );
    ...
    if (action === "CHANGE_LANGUAGE") {
      ...
      if (dataShop.manageId !== "" && dataListUser.length > 0) {
        ...
        this.setState({
          dataShop: { ...dataShop, valueOptions: newManageId[0] },
        });
      }
  ...
  render() {
    let { nameShop, addressShop, emailShop, phoneNumber, avata, valueOptions } =
      this.state.dataShop;
    let {
      isShowListsInput,
      listPay,
      ...
      <>
        <div className="l-12">
          <p className="heading-manage-user">
            <SwitchLanguage id="manageAdmin.manageShop" />
          </p>
        </div>
        ...
        >
          {!isShowListsInput && (
            <Button
              ...
              content={<SwitchLanguage id="manageAdmin.createShop" />}
        ...
        <div
          style={{ height: isShowListsInput ? "866" + "px" : "0" + "px" }}
        ...
        >
          <div className="list-input">
              ...
              >
                ...
                {!_.isEmpty(dataError.manageId)
                  ? language === languages.VI
                    ? dataError.manageId.valueVi
                    : dataError.manageId.valueEn
                  : ""}
              </span>
            </div>
            ...
            <div className="form-input col l-6">
              ...
              <span className="err">
                {!_.isEmpty(dataError.nameShop) && (
                  <FontAwesomeIcon icon={faCircleExclamation} />
                )}{" "}
                {!_.isEmpty(dataError.nameShop)
                  ? language === languages.VI
                    ? dataError.nameShop.valueVi
                    : dataError.nameShop.valueEn
                  : ""}
              </span>
            </div>
            ...
            <div
              className={
                isEdit
                  ? "form-input margin-top col l-6 "
                  : "form-input margin-top col l-12 "
              }
            >
              <label className="input-label">
                <SwitchLanguage id="manageAdmin.form.addressShop" />
              </label>
              <input
                type="text"
                className="input"
              ...
              <span className="err">
                {!_.isEmpty(dataError.addressShop) && (
                  <FontAwesomeIcon icon={faCircleExclamation} />
                )}{" "}
                {!_.isEmpty(dataError.addressShop)
                  ? language === languages.VI
                    ? dataError.addressShop.valueVi
                    : dataError.addressShop.valueEn
                  : ""}
              </span>
            </div>
          </div>
          ...
          <div className="list-input">
            <div className="form-input col l-6">
              <label className="input-label">
                <SwitchLanguage id="manageAdmin.form.emailShop" />
              </label>
              <input
                type="text"
                className="input"
              ...
              <span className="err">
                {!_.isEmpty(dataError.emailShop) && (
                  <FontAwesomeIcon icon={faCircleExclamation} />
                )}{" "}
                {!_.isEmpty(dataError.emailShop)
                  ? language === languages.VI
                    ? dataError.emailShop.valueVi
                    : dataError.emailShop.valueEn
                  : ""}
              </span>
            </div>
            ...
            <div className="form-input col l-6">
              <label className="input-label">
                <SwitchLanguage id="manageAdmin.form.phoneNumber" />
              </label>
              <input
                type="text"
                className="input"
          ...
          <div className="list-input">
            <div className="form-input col l-6">
              <label className="input-label">
                <SwitchLanguage id="manageAdmin.form.pay" />
              </label>
              <Select
                value={optionsPay}
                onChange={this.handlChangeSlelect}
              ...
              />
              <span className="err">
                {!_.isEmpty(dataError.pay) && (
                  <FontAwesomeIcon icon={faCircleExclamation} />
                )}{" "}
                {!_.isEmpty(dataError.pay)
                  ? language === languages.VI
                    ? dataError.pay.valueVi
                    : dataError.pay.valueEn
                  : ""}
              </span>
            </div>
