    ...
    render() {
        return (
            <div className={cx('not-found')}>
                <h1><SwitchLanguage  id='app.found.heading'/></h1>
                
                <p className={cx("zoom-area")}><SwitchLanguage  id='app.found.sub'/></p>
                ...
                <div className={cx("link-container")}>
                    <span><Link to={path.HOMEPAGE} className={cx("more-link")}><SwitchLanguage  id='app.found.back'/></Link></span>
                </div>
