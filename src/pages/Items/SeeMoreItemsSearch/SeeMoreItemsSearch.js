...
class SeeMoreItemsSearch extends Component {
    ...
    handleGetOrSetItems = async () => {
        ...
        let res = await appService.searchItemsNameNav({ idShop: idShop, category: category,type: type, language: language, value: value, limit: limit,  page: page})
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(SeeMoreItemsSearch));
