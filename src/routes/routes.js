...
const routes = [
  ...
  {
    path: path.RESGISTER_SELL,
    components: RegisterSell,
...
const routesProFie = [
  {
    path: path.PRO_FILE,
    components: ProFile,
    idText: "proFile.manageUser",
    icon: faGear,
  },
  {
    path: path.RESGISTER_SELL,
    components: RegisterSell,
    idText: "proFile.resgisterSell",
    role: PERMISSIONS.SELLER,
    icon: faBagShopping,
  },
  {
    path: path.MANAGE_SHOP,
    components: UserManage,
    idText: "proFile.manageShop",
    role: PERMISSIONS.PATIENT,
    icon: faBagShopping,
  },
  {
    path: path.DETAIL_ORDER,
    components: Invoice,
    idText: "proFile.manageOrder",
    icon: faCalendarWeek,
  },
  {
    path: path.LOGINPAGE,
    components: UserManage,
    idText: "manageAdmin.logout",
    status: "LOGOUT",
