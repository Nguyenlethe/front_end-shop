    ...
    return (
      <>
        {dataVoucher && (
          <div
            style={{
              height: isShow ? "100vh" : "0vh",
              opacity: isShow ? "1" : "0",
            }}
            className="detail-voucher"
            onClick={(e) => this.handleHideDetailVocher(e)}
          >
            <div className="voucher">
                ...
                <div className="info_shop">
                  <div className="border_img">
                    <img
                      ...
                      src={`${process.env.REACT_APP_BACKEND_IMAGES_AVT_SHOP}/${dataVoucher.Store.avata}`}
                      alt=""
                    />
                  </div>
                  <span className="name_shop">
                    {dataVoucher.Store.nameShop.length > 18
                      ? dataVoucher.Store.nameShop.slice(0, 18) + "..."
                      : dataVoucher.Store.nameShop}
                  </span>
                </div>
              </div>
              ...
              <div className="sub_voucher">
                ...
                <p className="limit">
                  ...
                  {languages.VI === language ? (
                    <NumberFormat
                      value={dataVoucher.Voucher.limitVn}
                      displayType={"text"}
                ...
                {dataVoucher.itemsId !== "EMPTY" &&
                  dataVoucher.Item &&
                  dataVoucher.Item.name && (
                    <div className="show_items">
                      <div className="img_items">
                        <img
                          className="img"
                          src={`${process.env.REACT_APP_BACKEND_IMAGES_ITEMS}/${dataVoucher.Items_color_image.image}`}
                          alt=""
                        />
                      </div>
                      ...
                      <div className="detail_items">
                        <p className="name_items">
                          {languages.EN === language
                            ? dataVoucher.Item.nameEn.slice(0, 22) + "..."
                            : dataVoucher.Item.name.slice(0, 22) + "..."}
                        </p>
                ...
                <p className="times">
                  ...
                  <span className="content-time">
                    ...
                    {":"}
                    {new Date(dataVoucher.dayStart).getMinutes() + "" === "0"
                      ? new Date(dataVoucher.dayStart).getMinutes() + "0"
                      : new Date(dataVoucher.dayStart).getMinutes()}
                    <span className="times">
                      {<SwitchLanguage id="manageAdmin.items.day" />}
                    </span>
                ...
                <p className="times">
                  ...
                  <span className="content-time">
                    ...
                    {":"}
                    {new Date(dataVoucher.dayEnd).getMinutes() + "" === "0"
                      ? new Date(dataVoucher.dayEnd).getMinutes() + "0"
                      : new Date(dataVoucher.dayEnd).getMinutes()}
                    <span className="times">
                      {<SwitchLanguage id="manageAdmin.items.day" />}
                    </span>
              ...
              <p
                className="l-12"
                onClick={(e) => this.handleHideDetailVocher(e, "BTN")}
              >
                <Button
