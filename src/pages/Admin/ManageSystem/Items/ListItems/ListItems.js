            ...
            <table id={cx("customers")}>
              <tbody>
                <tr>
                  <th>STT</th>
                  <th>
                    <SwitchLanguage id="manageAdmin.form.nameItemsListItems" />
                  </th>
                  <th>
                    <SwitchLanguage id="manageAdmin.form.codeItems" />
                  </th>
                  <th>
                    ...
                    return (
                      <tr key={item.idItems}>
                        ...
                        <td>
                          ...
                          />
                          <FontAwesomeIcon
                            onClick={() => this.handleDelete(item.idItems)}
                            className={cx("icon-tabel")}
                            icon={faTrashCan}
                          />
                        </td>
